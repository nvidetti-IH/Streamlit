...
def load_data():
    ...
    data_path = 'C:/Users/nvidetti/OneDrive - Independent Health/Documents/30 Days of Streamlit/Day4 Data/'
    df_agg = pd.read_csv(data_path + 'Aggregated_Metrics_By_Video.csv').iloc[1:,:]
    ...
    df_agg_sub = pd.read_csv(data_path + 'Aggregated_Metrics_By_Country_And_Subscriber_Status.csv')
    df_comments = pd.read_csv(data_path + 'Aggregated_Metrics_By_Video.csv')
    df_time = pd.read_csv(data_path + 'Video_Performance_Over_Time.csv')
...
median_agg = df_agg_diff.iloc[:,numeric_cols][df_agg_diff['Video publish time'] >= metric_date_12mo].median()
